...
function filterSelected() {
    var temp = $('#filterLink').attr('href') + "?setName=${setName}&filterKey=" + $('#headFilterSelect').val() + "&filterValue=" + $('#headFilterArea').val();
...
function doCustomFilter() {
    var temp = $('#customFilterLink').attr('href') + "?setName=${setName}&filterKey=" + $('#headFilterSelect').val() + "&filterValue=" + $('#headFilterArea').val()
...
<table width="95%" border="0" cellspacing="0" cellpadding="5" align="center">
    <tr>
        <td class="infobox" colspan="2">
            ...
            <a id="filterLink" class="filterLink" href="set_summary" onclick="filterSelected();">Filter</a>
            <c:if test='${!empty param.filterValue}'>
                / <a class="filterLink" href="set_summary?setName=${setName}">Remove Filter</a>
            </c:if>
    ...
    <tr>
        <td class="sectionHeader" colspan="7">${setName}</td>
    </tr>
    <c:forEach var="set" items="${availableSets}">
    <tr>
    ...
    <tr>
        <td colspan="7"><a id="customFilterLink" class="filterLink" href="set_summary" onclick="doCustomFilter();">FILTER</a>
