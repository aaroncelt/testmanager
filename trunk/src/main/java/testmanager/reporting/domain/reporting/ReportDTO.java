...
public class ReportDTO {
    ...
    // Required
    // start
    private String testName;	// testName the name of the test - class + method name or unique ID - MUST BE UNIQUE among all test names
    private String paramName;	// paramName the name or number of the test parameter "row" - unique for a test
    private String setName;		// setName the name of the set which the test belongs to - one test can belong to more sets
    private Date setStartDate;	// setStartDate the actual start date of the test set run. This will separate multiple runs of a single set.
    // stop
